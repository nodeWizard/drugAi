    ...
    <div className="bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md p-8 mb-8 hover:shadow-xl transition-shadow">
          ...
          <section className="bg-white rounded-lg shadow-md p-8 hover:shadow-xl transition-shadow">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <ul className="list-disc list-inside space-y-3 text-gray-700 text-lg ml-4">
                  <li>
                    <strong className="text-gray-900">Identification rapide de cibles :</strong> Les chercheurs 
                    peuvent rapidement identifier les protéines impliquées dans une maladie et comprendre leur structure.
                  </li>
                  <li>
                    <strong className="text-gray-900">Conception de médicaments :</strong> En connaissant la structure 
                  ...
                  <li>
                    <strong className="text-gray-900">Réduction des coûts :</strong> Moins d'expériences coûteuses 
                    en laboratoire sont nécessaires, réduisant le coût global du processus de découverte.
                  </li>
                  <li>
                    <strong className="text-gray-900">Accélération du processus :</strong> Ce qui prenait des années 
